...
export const OutroProvider = ({ children }) => {
  ...
  useEffect(() => {
    Papa.parse(
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vTZg7oUtiNr1MxOild1zCNj6P8AXk9gNMdHDXm6AtyUh6-YGNc4RdvHKP6OFixG1WQN4OY_xWWzW4Mu/pub?gid="+(localStorage.getItem("lang")=="en" ? "0" : "136221370")+"&single=true&output=csv",
      {
        download: true,
        header: true,
        complete: (results) => {
